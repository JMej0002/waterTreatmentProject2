...
The clarifier calculated volume ($V_{\text{clarifier}}^{\text{calc}}$) is determiSned using Eq.\eqref{eq:clarifier_volume} replacing the time $t$ with 
...
Tha sedimentation basin height is then selected based on the typical 
...
\begin{table}[h]
\caption{Typical design criteria for primary sedimentation basins \cite{metcalf_2014_wastewater}}
